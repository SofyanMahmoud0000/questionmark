          ...
          <nav class="navbar navbar-expand-lg"><a class="navbar-brand" href="{{asset('home')}}">{{app("AppName")}}</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active"><a class="nav-link" href="{{asset('notifications')}}"><i class="fas fa-bell"></i>Notifications
        ...
        <div class="mobile-nav">
          <nav class="navbar navbar-expand-lg">
            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item active"><a class="nav-link" href="{{asset('notifications')}}" title="Notifications"><i class="fas fa-bell"></i><span class="counts-notifications">{{app('User')->notifications}}</span></a></li>
            </ul>
          </nav>
        </div>
      </div>
    ...
    <main>
      <div class="container">
        ...
        @if($Count == 0)
          ...
          @else
            <div class="unpost">
            <a style = "background-color:#b20505;color:#acacac" href="{{asset('clearnotifications')}}">Clear all notifications</a>
            </div>
            <div class="row">
              ...
              @endif
                <div class="notification-content">
                  <div class="text-content">    
                    ...
                    @else
                    <div class="user"><a class="username" href="{{asset('profile/' . $n->data['user_id'])}}"><img class="img-fluid" src="{{$n->user_image}}"/></a><a class="time">{{$n->time}}</a></div>
                    @endif
                    @if(isset($n->data['Url']))
