          ...
          <nav class="navbar navbar-expand-lg"><a class="navbar-brand" href="home">{{app("AppName")}}</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active"><a class="nav-link" href="{{secure_asset('profile')}}"><i class="fas fa-user"></i>Profile</a></li>
        ...
        <div class="mobile-nav">
          <nav class="navbar navbar-expand-lg">
            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item active"><a class="nav-link" href="{{secure_asset('profile')}}" title="Profile"><img class="img-fluid" src="{{app('User')->image}}"/></a></li>
          ...
          <div class="questions">
            <div class="row">
                ...
                <div class="form-ask mb-20">
                  ...
                  <form method="post" action="{{secure_asset('createquestion')}}">
