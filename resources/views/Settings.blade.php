      ...
      <div class="container">
        ...
        <div class="mobile-nav">
          <nav class="navbar navbar-expand-lg">
            ...
            <ul class="navbar-nav ml-auto">
              <li class="nav-item active"><a class="nav-link" href="{{asset('home')}}" title="Feed"><i class="fas fa-home"></i></a></li>
      ...
      <div class="container">
        <div class="pop-up-setting">
          <div class="pop-name edit-user username"><a class="exit" href="#"><i class="fas fa-times closer"></i></a>
            ...
            <form method="GET" action="{{asset('changename')}}">
          ...
          <div class="pop-email edit-user email"><a class="exit" href="#"><i class="fas fa-times closer"></i></a>
            ...
            <form method="GET" action="{{asset('changeemail')}}">
          ...
          <div class="pop-photo photochange edit-user">
            <div class="box-photo"><a class="exit" href="#"><i class="fas fa-times closer"></i></a>
              <form method="POST" action="{{asset('changeimage')}}" enctype = "multipart/form-data"><span class="mb-20"><img class="img-fluid" src="{{app('User')->image}}"/>
          ...
          <div class="pop-photo coverchange edit-user">
            <div class="box-photo"><a class="exit" href="#"><i class="fas fa-times closer"></i></a>
              <form method="POST" action="{{asset('changecover')}}" enctype = "multipart/form-data"><span class="mb-20"><img class="img-fluid" src="{{app('User')->cover}}"/>
            ...
            <div class="main-column">
              <section>
                ...
                <div class="account-user tapcontent">
                  ...
                  @endif
                  <a class="delete-acc changed-btn" href="{{asset('deleteaccount')}}">Delete account</a>
                </div>
              </section>
            </div>
          </div>
