          ...
          <nav class="navbar navbar-expand-lg"><a class="navbar-brand" href="{{asset('home')}}">{{app("AppName")}}</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ml-auto">
                <li class="nav-item active"><a class="nav-link" href="{{asset('home')}}"><i class="fas fa-home"></i>Feed</a></li>
        ...
        <div class="mobile-nav">
          <nav class="navbar navbar-expand-lg">
            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item"><a class="nav-link" href="{{asset('inbox')}}" title="Inbox"><i class="fas fa-envelope"></i></a>
              </li>
                @if(app("User")->inbox)
                <span class="counts-message">{{app('User')->inbox}}</span></a>
                else
      ...
      <div class="menu-setting">
        <div class="inner-box">
          ...
          <ul class="list-unstyled">
            ...
            <li> <a href=href="{{asset('logout')}}">Log Out</a></li>
            <li> <a href="#">Help</a></li>
                  ...
                  <div class="post-content">
                    <div class="text-content">
                      <div class="question">
                        ...
                        <div class="reply"><a class="username" href="{{asset('profile/' . $D->replier_id)}}"><img class="img-fluid" src="{{$D->image2}}"/>{{$D->name2}}</a><a class="action"><i class="fas fa-reply"></i></a>
