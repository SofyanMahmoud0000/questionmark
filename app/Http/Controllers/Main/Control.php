...
class Control extends Controller
{
    ...
    public function Data(){
        ...
        $ActivatedLastTime = $Activated->count()-$Admin->ActivatedLastTime;
        $DeactivatedLastTime = $Deactivated->count()-$Admin->DeactivatedLastTime;

        $Admin->ActivatedLastTime = $Activated->count();
        $Admin->DeactivatedLastTime = $Deactivated->count();
        $Admin->save();


        return view("Data")
            ->with("Activated",$Activated)
            ->with("Deactivated",$Deactivated)
            ->with("ActivatedLastTime",$ActivatedLastTime)
            ->with("DeactivatedLastTime", $DeactivatedLastTime);
    }
}
